...
| --- | --- | --- |
| Auth | 회원가입 OTP, 비밀번호 설정/로그인/재설정, 브리지 토큰 발급 | [mobile/auth-and-gates.md](./mobile/auth-and-gates.md) |
...
| Board | 게시글/댓글/첨부/공지 연동 | [backend/board-api-and-notice-model.md](./backend/board-api-and-notice-model.md) |
| Referral | 추천코드 발급/백필/비활성 | [data/referral-schema-and-admin-rpcs.md](./data/referral-schema-and-admin-rpcs.md) |
