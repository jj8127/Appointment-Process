...
serve(async (req: Request) => {
  ...
  const actorCheck = await requireActor(req, body, 'board-comment-delete', origin);
  ...
  if (
    ...
    return json({ ok: false, code: 'forbidden', message: 'cannot delete this comment' }, 403, origin);
  }
