...
describe('board-update notification contract', () => {
  ...
  it('notifies board readers after a successful update', () => {
    ...
    expect(source).toContain("sendBoardPush('fc', notificationTitle, updatedTitle, targetUrl, target,");
    expect(source).toContain("sendBoardPush('admin', notificationTitle, updatedTitle, targetUrl, target,");
